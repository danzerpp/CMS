        ...
        http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST_URL)
                                ...
                                .requestMatchers("/api/admin/recipes/**").hasAuthority("ADMIN")
                                .requestMatchers("/api/admin/units/**").hasAuthority("ADMIN")
                                .requestMatchers("/api/admin/ingredients/**").hasAuthority("ADMIN")
